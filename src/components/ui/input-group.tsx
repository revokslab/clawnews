...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: layout wrapper; fieldset would change form semantics and styling
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: addon forwards focus to input; not a button
    <div
